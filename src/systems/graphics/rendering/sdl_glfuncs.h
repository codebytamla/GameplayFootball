...
SDL_PROC(void,glUnmapBuffer,(GLenum target))
...
SDL_PROC(GLuint,glCreateShader,(GLenum shaderType))
SDL_PROC(void,glGetShaderInfoLog,(GLuint shader, GLsizei maxLength, GLsizei *length, GLchar *infoLog))
...
SDL_PROC(void,glDrawBuffers,(GLsizei n,    const GLenum *bufs))
SDL_PROC(void,glShaderSource,(GLuint shader,    GLsizei count,    const GLchar **string,    const GLint *length))
...
SDL_PROC(void,glBindFragDataLocation,(GLuint program,    GLuint colorNumber,    const char * name))
...
SDL_PROC(void,glVertexAttribPointer,(GLuint index,    GLint size,    GLenum type,    GLboolean normalized,    GLsizei stride,    const GLvoid * pointer))
...
SDL_PROC(void*,glMapBufferRange,(GLenum target,    GLintptr offset,    GLsizeiptr length,    GLbitfield access))
...
SDL_PROC_UNUSED(void,glLoadIdentity,(void))
...
SDL_PROC_UNUSED(void,glMatrixMode,(GLenum mode))
...
SDL_PROC_UNUSED(void,glOrtho,(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar))
...
SDL_PROC_UNUSED(void,glTexEnvf,(GLenum target, GLenum pname, GLfloat param))
